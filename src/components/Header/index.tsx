...
export function Header({
  ...
  const handleCreateButton = () => {
    setAssignmentList([...assignmentList, {id: assignmentList.length, task: assignment, completed: false}]);
    setAssignment('');
  };
  ...
  return (
    <header className={styles.header}>
      ...
      <form className={styles.newAssignmentForm}>
        ...
        />
        <button type="button" disabled={!assignment.trim()} onClick={handleCreateButton}>
